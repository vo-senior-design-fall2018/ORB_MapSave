...
*/
    ...
    boardSize.width = atoi(argv[1]);
    boardSize.height = atoi(argv[2]);
    float squareSize = stof(argv[3]);
    imagelistfn = (string)argv[4];
